        ...
        <main className="grow">
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto ">
            ...
            <div className="max-w-3xl m-auto" >
              ...
              {/* Page title */}
              <div className="mb-5">
                <h1 className="text-2xl md:text-3xl text-slate-800 dark:text-slate-100 font-bold"> איך אפשר לעזור לך ?</h1>
              </div>
              ...
              {/* Filters */}
              <div className="mb-8 border-b border-slate-200 dark:border-slate-700 mr-8">
